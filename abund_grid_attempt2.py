...
if all:
    pkl.dump(nlte_dict, open(element + "nlte_impact_dict_all.pkl", "wb"))
    pkl.dump(ew_dict, open(element + "ew_dict_all.pkl", "wb"))
    pkl.dump(abund_dict, open(element + "abund_dict_grid_all.pkl", "wb"))

else:

    pkl.dump(nlte_dict, open(element + "nlte_impact_dict.pkl", "wb"))
    pkl.dump(ew_dict, open(element + "ew_dict.pkl", "wb"))
    pkl.dump(abund_dict, open(element + "abund_dict_grid.pkl", "wb"))
