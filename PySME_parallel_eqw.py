...
def ew(windex, NLTE, ion, line, element, newrun):
    ...
    for x in range(len(params.values)):
        if int(params.values[x][1]) == 5750 and 3.50 == round(params.values[x][2], 1)  and -2.50 == round(params.values[x][3], 2) and 1.00== round(params.values[x][4], 2) and  round(params.values[x][5], 2)  == -1:
    ...
    line_dir = '/home/jama2357/Documents/TiFeAtoms/DepartureGrid/CoG/linelists/'
    NLTE_dir = "/home/jama2357/Documents/TiFeAtoms/DepartureGrid/CoG/NLTE_grids/"
    ...
    if NLTE == 'y':
        sme.nlte.set_nlte(element, grid = r"/home/jama2357/Documents/TiFeAtoms/DepartureGrid/pysme/nlte_Ti_ama51_Nov2022_pysme.grd")
        print(sme.nlte.subgrid_size)
        sme.nlte.solar = 'grevesse2007'
        print(sme.nlte)
    elif NLTE=="n":
        print("LTE here")

        sme.nlte.remove_nlte(element)
    ...
    try:
        ...
        print("             index, Teff, logg, feh, vmic, enh")
        print("atmos error", our_params)
