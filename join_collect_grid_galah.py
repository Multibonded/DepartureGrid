...
data=pd.read_csv('{}_lines_galah'.format(element),delim_whitespace=True)
...
for w in wg:
    ...
    filename = glob.glob('grids/{}/{}_{}_galah.pkl'.format(element, element, w))
...
outfile=open("grids/{}_galah.pkl".format(element),"wb")
