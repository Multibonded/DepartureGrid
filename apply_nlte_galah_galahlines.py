...
def solar_twin_lines(element):
    ...
    if reduced:
        b = pkl.load(open(element + "_Galah_impacts2_Ati_reduced_galah.pkl", "rb"))
        c = pkl.load(open(element + "_Galah_impacts_lineless2_Ati_reduced_galah.pkl", "rb"))

    else:
        b = pkl.load(open(element + "_Galah_impacts2_Ati_galah.pkl", "rb"))
        c = pkl.load(open(element + "_Galah_impacts_lineless2_Ati_galah.pkl", "rb"))
...
def run_all(element):
    ...
    """if reduced:
        ...
        star_count = pkl.load(open(element + "Accurate_param_indexes_galah.pkl", "rb"))
    """
    abund_dict = pkl.load(open(element + "nlte_impact_dict_galah.pkl", "rb"))
    ew_dict = pkl.load(open(element + "ew_dict_galah.pkl", "rb"))
    star_count = pkl.load(open(element + "Accurate_param_indexes_galah.pkl", "rb"))
    ...
    if "1" in element:
        if all:
            ...
            lines = ['4758','4759','4781','4801','4820','5739']
        ti_ab = {}
    ...
    for starn in star_count:
        ...
        for line_index in range(len(lines)):
            ...
            pklfile = open('grids/{}_galah.pkl'.format(element), 'rb')
    ...
    if reduced:
        pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_Ati_reduced_galah.pkl", "wb"))
        pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_Ati_reduced_galah.pkl", "wb"))


    else:
        pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_Ati_galah.pkl", "wb"))
        pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_Ati_galah.pkl", "wb"))

    pickle.dump(redew_dict, open(element+"Reducedews_galah.pkl", "wb"))
...
def turn_ti_tih(element):
    ...
    nlte_list = []
    if reduced:
        full_galah_nlte = pickle.load(open(element + "_Galah_impacts2_Ati_reduced_galah.pkl", "rb"))

    else:
        full_galah_nlte = pickle.load(open(element + "_Galah_impacts2_Ati_galah.pkl", "rb"))
    ...
    if save:
        ...
        if reduced:
            pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_reduced_galah.pkl", "wb"))
            pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_reduced_galah.pkl", "wb"))

            pickle.dump([feh_list, nlte_list], open(element + "_NLTE_list2_reduced_galah.pkl", "wb"))

        else:

            pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_galah.pkl", "wb"))
            pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_galah.pkl", "wb"))

            pickle.dump([feh_list, nlte_list], open(element + "_NLTE_list2_galah.pkl", "wb"))
