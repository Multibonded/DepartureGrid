...
sunfile = "/home/jama2357/Downloads/J_A+A_587_A65_spvis.dat.gz.fits"
atom = fits.open(sunfile)
atom1 = atom[1].data
...
#pkl.dump(nlte_dict, open(element + "nlte_impact_dict_galah.pkl", "wb"))
#pkl.dump(ew_dict, open(element + "ew_dict_galah.pkl", "wb"))
#pkl.dump(abund_dict, open(element + "abund_dict_grid_galah.pkl", "wb"))
