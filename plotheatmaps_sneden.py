...
def plot_basic_corrections(element):
    b = pkl.load(open(element + "_sneden_impacts2.pkl", "rb"))
    a = pkl.load(open(element + "_sneden_NLTE_list2.pkl", "rb"))
    ...
    plt.savefig("graphs/sneden//"+element+"NLTE_Corrections_sneden.jpg")
    plt.show()
...
def plot_both():
    ...
    plt.savefig("graphs/sneden//Both_NLTE_Corrections_sneden.jpg")
    plt.show()
...
def color_single(element):
    b = pkl.load(open(element + "_sneden_impacts2.pkl", "rb"))
    a = pkl.load(open(element + "_sneden_NLTE_list2.pkl", "rb"))
    c = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
    ...
    plt.savefig("graphs/sneden//NLTEimpact_Colormap_"+element+"sneden.png", bbox_inches="tight")
    plt.show()
...
def basic_ltenlte_compare(element):
    ...
    plt.legend()
    plt.savefig("graphs/sneden//"+element+"_simpleLTE2_sneden.png")
    plt.show()
...
def heatmap_lte(element, nltetrue):
    ...
    plt.savefig("graphs/sneden//"+nltestring+"Colormap_"+element+"2_sneden.png")
    plt.show()
...
def scatter():
    ...
    for element in elementlist:
        ...
        if load:
            ...
            linedict = pkl.load(open(element + "_sneden_impacts2.pkl", "rb"))
        ...
        plt.savefig("graphs/sneden//"+element+"_STD2_sneden.png")
        plt.show()
...
def ion_imbalance():
    ...
    for element in ["Ti1"]:
        ...
        impact = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
        if element == "Ti1":
            alt_impact = pkl.load(open("Ti2_sneden_impacts_lineless2.pkl", "rb"))
        else:
            alt_impact = pkl.load(open("Ti1_sneden_impacts_lineless2.pkl", "rb"))
        nlte_imbalance_list = []
        lte_imbalance_list = []
        logg_list = []
        feh_list = []
        ...
        plt.legend()
        plt.savefig("graphs/sneden//ionisation_imbalance_both2_sneden.png", bbox_inches="tight")
        plt.show()
...
def excitation_balance():
    for lteval in [False, True]:
        ...
        elementstr = "Ti I"
        linedict = pkl.load(open(element + "_sneden_impacts2.pkl", "rb"))
        lineless = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
        ...
        plt.savefig("graphs/sneden//Exctitation_imbalance_"+ltestring+"2_sneden.png")
        plt.xlabel("[Fe/H]")
...
def galactic_evolution():
    for element in ["Ti1", "Ti2"]:
        for lteval in [True, False]:
            ...
            plt.savefig("graphs/sneden//GCE_abundances_"+element+ltestring+"2_sneden.png")
            plt.show()
...
def galactic_evolution_trendlines():
    ...
    for element in ["Ti1", "Ti2"]:
        ...
        plt.savefig("graphs/sneden//"+element+"GCE_Trendlines2_sneden.png", bbox_inches="tight")
        plt.show()
...
def hr_diag():
    for element in ["Ti1", "Ti2"]:
        ...
        plt.savefig("graphs/sneden///"+str(element)+"HRdiagNLTE2_sneden.png", bbox_inches="tight")
        plt.show()
...
def exc_energy(element):
    ...
    plt.legend()
    plt.savefig("graphs/sneden//"+str(element)+"excitation_energy_NLTE2_sneden.png")
    plt.show()
...
def color_single_fe():
    ...
    plt.savefig("graphs/sneden//NLTEimpact_Colormap_Fe_2_sneden.png", bbox_inches="tight")
    plt.show()
def scatter_fe():
    elementlist  = ["Ti2", "Ti1"]
    fig = plt.figure()
    ...
    plt.savefig("graphs/sneden//STD_fe2_sneden.png")
    plt.show()
import pandas as pd
def ion_imbalance_fe():
    ...
    for element in ["Ti1"]:
        ...
        #plt.legend()
        plt.savefig("graphs/sneden//ionisation_imbalance_both_Fe2_sneden.png", bbox_inches="tight")
        plt.show()
...
def galactic_evolution_trendlines_ionmean():
    ...
    for element in ["Ti1", "Ti2"]:
        ...
        plt.ylabel("[Ti/Fe]")
    print(len(lineless))
    plt.savefig("graphs/sneden//GCE_Trendlines_overall2_sneden.png", bbox_inches="tight")
    plt.show()
...
def galactic_evolution_trendlines_fe():
    ...
    for element in ["Ti1", "Ti2"]:
        ...
        plt.savefig("graphs/sneden//"+element+"GCE_Trendlines_fe2_sneden.png", bbox_inches="tight")
        plt.show()
...
def galactic_evolution_trendlines_fe_line(wl):
    ...
    for lteval in [False, True]:
        lined = pkl.load(open(element + "_sneden_impacts2.pkl", "rb"))
        a = pkl.load(open(element + "_sneden_NLTE_list2.pkl", "rb"))
        lineless = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
        sns.set_theme(style="whitegrid")
    ...
    plt.savefig("graphs/sneden//wlscatter/"+element+"GCE_Trendlines_fe_"+str(wl)+"2_sneden.png", bbox_inches="tight")
...
def ion_imbalance_fe_line():
    ...
    for element in ["Ti1"]:
        ...
        # Teff logg feh vmic lteabund nlteIMPACT
        impact_orig = pkl.load(open(element + "_sneden_impacts2.pkl", "rb"))
        impact = pkl.load(open(element + "_sneden_impacts2.pkl", "rb"))
        # just roll with it, it's intentional
        if element == "Ti1":
            alt_impact = pkl.load(open("Ti2_sneden_impacts2.pkl", "rb"))
        ...
        plt.ylabel("[Ti/Fe]$_\mathrm{Ti\ I-Ti\ II}$")
        plt.legend()
        plt.savefig("graphs/sneden//ionimb_lines/ionisation_imbalance_both_Fe_linespecific2_sneden.png", bbox_inches="tight")
...
def galactic_evolution_trendlines_fe_line_removal():
    ...
    for element in ["Ti2", "Ti1"]:
        ...
        for lteval in [False, True]:
            ...
            lineless_original = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
            lineless = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
        ...
        plt.savefig("graphs/sneden//wlscatter/"+element+"GCE_Trendlines_fe_removedlines2_sneden.png", bbox_inches="tight")
        plt.show()
...
def galactic_evolution_trendlines_fe_splitup():
    ...
    for element in ["Ti1", "Ti2"]:
        ...
        trenddict[element] = {}
        for lteval in [False, True]:
            if element == "Ti1" and not lteval:
                ax = fig.add_subplot(1, 1, 1, projection="scatter_density")
                plt.ylabel("[Ti/Fe]$_\mathrm{Ti\ I}$")


            elif element == "Ti2" and not lteval and 100==2:
                ax = fig.add_subplot(1, 2, 2, projection="scatter_density")
                plt.xlabel("Metallicity [Fe/H]")
                plt.ylabel("[Ti/Fe]$_\mathrm{Ti\ II}$")
            ...
            for y in np.arange(min(feh), max(feh), 0.2):
                windwarf = \
                np.where(np.logical_and(np.logical_and(np.logical_and(y - 0.1 <= feh, feh <= y + 0.1), np.asarray(logg) > 3.5), np.asarray(vmic) != 11.114))[0]
                winmeandwarf = np.mean(np.asarray(abundance)[windwarf])
                if not len(windwarf) <1:
                    trendfehdwarfs.append(y)
                    trendnltedwarfs.append(winmeandwarf)
            ...
            if lteval:
                ...
                if element == "Ti1":
                    ...
                    col = "darkorange"
                    elementstring = "Ti II"
            print("dwarfs:", len(trenddict[element][lteval][0]))
            sns.lineplot(x=trenddict[element][lteval][2], y=trenddict[element][lteval][0], label=elementstring+" "+ ltestring+" dwarfs ("+str(dwarfcount)+")", color = col, linewidth =2)
            #sns.lineplot(x=trenddict[element][lteval][3], y=trenddict[element][lteval][1], linestyle="--", color=col,                         label=elementstring+" " + ltestring+" giants ("+str(giantcount)+")", linewidth =2)
    ...
    plt.savefig("graphs/sneden//Split_GCE_Trendlines_fe2_sneden.png", bbox_inches="tight")
    plt.show()
...
def ion_imbalance_fe_split():
    ...
    for element in ["Ti1"]:
        ...
        if reduced:
            impact_orig = pkl.load(open(element + "_sneden_impacts_lineless2_reduced.pkl", "rb"))
            impact = pkl.load(open(element + "_sneden_impacts_lineless2_reduced.pkl", "rb"))

            alt_impact = pkl.load(open("Ti2_sneden_impacts_lineless2_reduced.pkl", "rb"))
        else:
            impact_orig = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
            impact = pkl.load(open(element + "_sneden_impacts_lineless2.pkl", "rb"))
        ...
        for lteval in [True, False]:
            ...
            giantfeh = []
            giantion = []
            dwarfs = np.where(np.asarray(logg_list))
            ...
            for y in np.arange(min(feh_list), max(feh_list), 0.2):
                print("y", y)
                windwarf = np.where(np.logical_and(y - 0.1 <= feh_list, feh_list <= y + 0.1)              )[0]
        ...
        #pkl.dump([feh_list, nlte_imbalance_list, lte_imbalance_list, logg_list], open("ion_imbalance_feh_nlte_lte2.pkl", "wb"))
            ...
            for star in ['giant', 'dwarf']:
                ...
                if star == "giant":
                    ...
                    """
                    plt.xlabel("Metallicity [Fe/H]")
                    sns.scatterplot(x=dwarffeh, y=dwarfion, color=clr)
                    plt.ylabel("[Ti/Fe]$_\mathrm{Ti\ I-Ti\ II}$")

                    plt.ylim(-0.3, 0.3)
                    plt.legend(loc="lower left")
                    plt.hlines(0, -5.5, 0.5, linestyles="--", color="grey", linewidth =2)
                    plt.xlim(-2.6, -2)
                    if lteval:
                        linesty = "-"
                    else:
                    ...
                    sns.lineplot(x=trendfehdwarfs, y=trenddwarfs, linestyle=linesty, color=clr, label = ltestring+ " dwarfs ("+ str(len(dwarffeh))+")")
        ...
        #plt.legend()
        plt.savefig("graphs/sneden//Comb_ionimb2_sneden.png", bbox_inches="tight")
        plt.show()
...
def galactic_evolution_trendlines_fe_splitup_testlogg():
    ...
    for element in ["Ti2", "Ti1"]:
        ...
        for lteval in [False, True]:
            ...
            #plt.title("Titanium abundance trend lines")
            plt.legend(loc="lower left")
    plt.savefig("graphs/sneden//logg_Split_GCE_Trendlines_fe2_sneden.png", bbox_inches="tight")
    plt.show()
    ...
    for startype in ['dwarf', 'giant']:
        ...
        for element in ["Ti1", "Ti2"]:
            ...
            for lteval in [False, True]:
                ...
                #plt.title("Titanium abundance trend lines")
                plt.legend(loc="lower left")
        plt.savefig("graphs/sneden//Split_GCE_Trendlines_fe2_"+startype+"_sneden.png", bbox_inches="tight")
        plt.show()
...
def hr_diag_rev():
    for element in ["Ti1"]:
        ...
        plt.xlabel("Log($g$)")
        plt.savefig("graphs/sneden//HRdiagNLTE2_reversed_sneden.png", bbox_inches="tight")
        plt.show()
...
def color_single_fe_teff():
    ...
    plt.savefig("graphs/sneden//NLTEimpact_Colormap_Teff_2_sneden.png", bbox_inches="tight")
    plt.show()
def color_single_fe_logg():
    ...
    plt.savefig("graphs/sneden//NLTEimpact_Colormap_Logg_2_sneden.png", bbox_inches="tight")
    plt.show()
    ...
    for element in ["Ti1", "Ti2"]:
        ...
        for startype in ["dwarf", "giant"]:
            ...
            if "dwarf" in startype:
                ...
                plt.title("Giants")
    plt.savefig("graphs/sneden//linescatter_sneden.png")
    plt.show()
def hr_diag_absolute():
    ...
    for element in ["Ti1", "Ti2"]:
        ...
        # Teff logg feh vmic lteabund nlteIMPACT
        impact = pkl.load(open(element + "_sneden_impacts_lineless2_Ati.pkl", "rb"))
        nlteimpact = []
        lte_imbalance_list = []
        logg_list = []
        feh_list = []
        ...
        if "1" in element:
            plt.ylabel("log(g / cm s$^{-2}$)")
        plt.savefig("graphs/sneden///"+str(element)+"HRdiagNLTE2_absolute_sneden.png", bbox_inches="tight")
        plt.show()
