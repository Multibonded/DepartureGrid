...
element, stars, NLTE, ion, line= sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5]
...
teff, logg, monh, vmic, enh = 4286, 1.64, -0.52, 1.33, 0.50
EleIon = element + ion

# target specifies filenames, index used to keep track of progress
target = "{}_{}_{}_{}_{}_{}".format('Arcturus',teff,logg,monh,vmic,enh)

if NLTE == 'y':
    target = target + "_NLTE"
    print("\n Synthesizing {} in NLTE for parameters {}".format(element,'Arcturus'))
else:
    target = target + "_LTE"
    print("\n Synthesizing {} in LTE for parameters {}".format(element,'Arcturus'))
...
sme.atmo.source = "/cfs/klemming/projects/snic/pdc-bus-2022-4/klind/atmosphere_grids/marcs_sph_ae.sav"
...
print("\n EW {} {} {} {} {}".format(smeEW,'Arcturus: ',NLTE,element,line))
#print(smeEW)
