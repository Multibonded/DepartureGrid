...
def solar_twin_lines(element):
    ...
    if reduced:
        b = pkl.load(open(element + "_Galah_impacts2_Ati_reduced_vmic2.pkl", "rb"))
        c = pkl.load(open(element + "_Galah_impacts_lineless2_Ati_reduced_vmic2.pkl", "rb"))
        if all:
            b = pkl.load(open(element + "_Galah_impacts2_Ati_reduced_all_vmic2.pkl", "rb"))
            c = pkl.load(open(element + "_Galah_impacts_lineless2_Ati_reduced_all_vmic2.pkl", "rb"))

    else:
        b = pkl.load(open(element + "_Galah_impacts2_Ati_vmic2.pkl", "rb"))
        c = pkl.load(open(element + "_Galah_impacts_lineless2_Ati_vmic2.pkl", "rb"))
        if all:
            b = pkl.load(open(element + "_Galah_impacts2_Ati_all_vmic2.pkl", "rb"))
            c = pkl.load(open(element + "_Galah_impacts_lineless2_Ati_all_vmic2.pkl", "rb"))
...
def run_all(element):
    ...
    if reduced:
        if all:
            pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_Ati_reduced_all_vmic2.pkl", "wb"))
            pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_Ati_reduced_all_vmic2.pkl", "wb"))
        else:
            pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_Ati_reduced_vmic2.pkl", "wb"))
            pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_Ati_reduced_vmic2.pkl", "wb"))


    else:
        if all:
            pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_Ati_all_vmic2.pkl", "wb"))
            pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_Ati_all_vmic2.pkl", "wb"))
        else:
            pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_Ati_vmic2.pkl", "wb"))
            pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_Ati_vmic2.pkl", "wb"))

    if all:
        pickle.dump(redew_dict, open(element+"Reducedews_all_vmic2.pkl", "wb"))
    else:
        pickle.dump(redew_dict, open(element+"Reducedews_vmic2.pkl", "wb"))
...
def turn_ti_tih(element):
    ...
    if reduced:
        if all:
            full_galah_nlte = pickle.load(open(element + "_Galah_impacts2_Ati_reduced_all_vmic2.pkl", "rb"))
        else:
            full_galah_nlte = pickle.load(open(element + "_Galah_impacts2_Ati_reduced_vmic2.pkl", "rb"))

    else:
        if all:
            full_galah_nlte = pickle.load(open(element + "_Galah_impacts2_Ati_all_vmic2.pkl", "rb"))
        else:
            full_galah_nlte = pickle.load(open(element + "_Galah_impacts2_Ati_vmic2.pkl", "rb"))
    ...
    if save:
        ...
        if reduced:
            if all:
                pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_reduced_all_vmic2.pkl", "wb"))
                pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_reduced_all_vmic2.pkl", "wb"))

                pickle.dump([feh_list, nlte_list], open(element + "_NLTE_list2_reduced_all_vmic2.pkl", "wb"))
            else:
                pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_reduced_vmic2.pkl", "wb"))
                pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_reduced_vmic2.pkl", "wb"))

                pickle.dump([feh_list, nlte_list], open(element + "_NLTE_list2_reduced_vmic2.pkl", "wb"))

        else:
            if all:
                pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_all_vmic2.pkl", "wb"))
                pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_all_vmic2.pkl", "wb"))

                pickle.dump([feh_list, nlte_list], open(element + "_NLTE_list2_all_vmic2.pkl", "wb"))
            else:

                pickle.dump(full_galah_nlte, open(element + "_Galah_impacts2_vmic2.pkl", "wb"))
                pickle.dump(star_mean_dict, open(element + "_Galah_impacts_lineless2_vmic2.pkl", "wb"))

                pickle.dump([feh_list, nlte_list], open(element + "_NLTE_list2_vmic2.pkl", "wb"))
